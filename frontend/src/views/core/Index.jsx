...
function Index() {
    ...
    const fetchCategory = async () => {
        ...
        const filteredCategories = response.data
            .filter((c) => c.post_count > 0) // Filter categories with more than 0 articles
    ...
    const popularItems = popularPosts;
    const trendingItems = trendingPosts.slice(indexOfFirstItem, indexOfLastItem);
