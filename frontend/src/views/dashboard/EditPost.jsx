...
function EditPost() {
    ...
    const fetchPost = async () => {
        const response = await apiInstance.get(`author/dashboard/post-detail/${userId}/${param.post_id}/`);
    ...
    const handleCreatePost = async (e) => {
        ...
        try {
            const response = await apiInstance.patch(`author/dashboard/post-detail/${userId}/${param.post_id}/`, formdata, {
                headers: {
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <JoditEditor
                                                    ...
                                                    onChange={(newContent) =>
                                                        setEditPost({ ...post, description: newContent }) // Update description in state
                                                    }
